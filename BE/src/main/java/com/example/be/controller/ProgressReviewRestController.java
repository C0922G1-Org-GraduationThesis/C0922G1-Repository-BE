...
public class ProgressReviewRestController {
     ...
     * Created by: VuLX
     * Date created: 02/04/2023
     * Function: change status project By projectId until deadline
     *
     * @return HttpStatus.NO_CONTENT if result is null or HttpStatusOK if result is not null
     */
     ...
     * Created by: VuLX
     * Date created: 02/04/2023
     * Function: change status project until deadline
     *
     * @return HttpStatus.NO_CONTENT if result is null or HttpStatusOK if result is not null
     */
     ...
     * Created by: VuLX
     * Date created: 02/04/2023
     * Function: save progress project when project is checked
     *
     * @return HttpStatus.NO_CONTENT if result is null or HttpStatusOK if result is not null
     */
//----------------------------Sau 1 giây sẽ tự động insert vào--------------------------------
