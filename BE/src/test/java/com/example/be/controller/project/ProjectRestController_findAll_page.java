...
public class ProjectRestController_findAll_page {
    @Autowired
    ...
    public void findAllProject_7() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/projects/?page={page}&searchName=thiết&size=5", "null"))
                .andDo(print())
    ...
    public void findAllProject_8() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/projects/?page={page}&searchName=thiết&size=5",""))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
    ...
    public void findAllProject_9() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/projects/?page={page}&searchName=thiết&size=5","100"))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
