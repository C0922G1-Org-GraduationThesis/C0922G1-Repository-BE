...
public class ProjectRestController_findAll_nameSearch {
    ...
    public void findAllProject_7() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get(
                                "/api/projects/?nameSearch={nameSearch}&size=5&page=0", "null"))
                .andDo(print())
    ...
    public void findAllProject_8() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/projects/?nameSearch={nameSearch}&size=5&page=0",""))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
    ...
    public void findAllProject_9() throws Exception {
        ...
        this.mockMvc.perform(
                        MockMvcRequestBuilders.get(
                                "/api/projects/nameSearch={nameSearch}&size=5&page=0", "a123"))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
