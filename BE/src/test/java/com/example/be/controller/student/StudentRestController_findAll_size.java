...
public class StudentRestController_findAll_size {
    @Autowired
    ...
    public void findAllStudent_7() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/students/?size={size}&searchStr=Doe&page=0", "null"))
                .andDo(print())
    ...
    public void findAllStudent_8() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/students/?size={size}&searchStr=Doe&page=0",""))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
    ...
    public void findAllStudent_9() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/students/?searchStr=Doe&page=0&size={size}","-1"))
                .andDo(print())
                .andExpect(status().is4xxClientError());
    }
